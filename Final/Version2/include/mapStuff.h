 ...
 * @param mapLocks a vector that stores locks that are sized according to an individual map, either 1 2 or 3
 */

void addFragment( std::vector<Map>& map, fragment& frag, std::vector<pthread_mutex_t>& mapLocks);
