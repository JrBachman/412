...
//all functions defined in mapStuff.h doxygen style
...
//reads fragment and gets rgb values
fragment readFragment(const string& filePath){
...
//devides sum of rgb by count and makes an output image
...
//adds a fragment to a map by incrementing the count on valid pixels and adds rgb to sums
void addFragment( vector<Map>& map, fragment& frag, vector<pthread_mutex_t>& mapLocks){
